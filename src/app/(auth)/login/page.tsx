      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" action={login}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 rounded border-zinc-300 text-teal-700 focus:ring-teal-700 dark:border-zinc-800 dark:bg-zinc-900"
              />
          ...
          <div>
            <button
              type="submit"
              className="group relative flex w-full justify-center rounded-xl bg-teal-700 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-teal-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700 transition-all active:scale-95"
            >
              Sign in
            </button>
          </div>
